...
export function loadAlphabets() {
  ...
  if (!alphabets) {
    alphabets = {
      ...
      'legacy': {
        name: 'Legacy',
        summary: 'A-Za-z0-9 without E',
        // 'ABCDFGHIJKLMNOPQRSTUVWXYZabdfghijklmnopqrstuvwxyz1234567890'
        chars: hex2bin('00410042004300440046004700480049004a004b004c004d004e004f0050005100520053005400550056005700580059005a0061006200640066006700680069006a006b006c006d006e006f0070007100720073007400750076007700780079007a0031003200330034003500360037003800390030'),
      },
      'bug': {
        name: 'With unicode bugs',
        summary: 'A-Za-z0-9!@#$%*()_+=-?[]{}",./<>| and <space>ñÑ€¡¿ç',
      ...
      'crazy': {
        name: 'Crazy',
        summary: 'Weird unicode characters',
        // 'ꓯꓭꓛꓷꓱꓞꓨꓩꓘꓶꟽИꟼꓤƧꓕꓵꓥ༽᚛᚜‹›⁅⁆⁽⁾₍₎⅀∁∂∃∄∈∉∊∋∌∍∑∕∖√∛∜∝∟∠∡∢∤∦∫∬∭∮∯∰∱∲∳∹∻∼∽∾∿≀≁≂≃≄≅≆≇≈≉≊≋≌≒≓≔≕≟≠≢≤≥≦≧≨≩≪≫≮≯≰≱≲≳≴≵≶≷≸≹≺≻≼≽≾≿⊀⊁⊂⊃'
